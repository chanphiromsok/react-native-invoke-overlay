...
//  public static final int OP_WRITE_MMS = 10006;
  ...
  public static boolean checkXiaomiPermission(ReactApplicationContext context, int permission) {
    try {
      ...
      int result = (int) method.invoke(mgr, permission, android.os.Process.myUid(), context.getPackageName());
      return result == AppOpsManager.MODE_ALLOWED;
    } catch (Exception e) {
      Log.d("XiaomiUitils",e.toString());
    }
    return true;
  }


  public static Intent getPermissionManagerIntent(ReactApplicationContext context) {
